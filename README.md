Executive Summary
รายงานฉบับนี้มีเพื่อพัฒนาระบบ Merchant Guard โดยมีเป้าหมายเพื่อยกระดับ Trust & Safety ในระบบ onboarding ของ merchant โดยตรวจสอบความสอดคล้องเชิงความหมาย (semantic consistency) ระหว่าง ภาพที่ merchant อัปโหลด กับ หมวดหมู่ร้านค้าที่เลือก แบบอัตโนมัติด้วย AI
